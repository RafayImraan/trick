            ...
            <div className="hero-shell">
              <div className="hero-copy fade-in">
                ...
                <div className="hero-actions">
                  <Link href="/login" className="btn-primary fs-cta" style={{ fontSize: 18, padding: '16px 30px' }}>
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                      <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.41-1.41L10 14.17l7.59-7.59L19 8l-9 9z" />
                    </svg>
                    Get Started
                  </Link>
                  <Link href="#how-it-works" className="btn-secondary fs-cta" style={{ fontSize: 18, padding: '16px 30px' }}>
                    Learn More
                  </Link>
                </div>
              ...
              <div className="panel hero-card slide-up">
                <div className="hero-card-grid">
                  <div className="hero-spotlight">
                    ...
                    <h3 className="fs-spotlight-h3" style={{ fontSize: 32, marginBottom: 10 }}>From link to payment in three moves.</h3>
                  ...
                  <div className="hero-card-grid-inner" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
                    <div className="stack-card">
                      ...
                      <h3 style={{ marginBottom: 8 }}>Generate link</h3>
                    ...
                    <div className="stack-card">
                      ...
                      <h3 style={{ marginBottom: 8 }}>Receive privately</h3>
          ...
          <div className="container">
            ...
            <div className="feature-grid">
              <div className="glass-card feature-card">
                ...
                <h3 className="fs-feature-h3" style={{ fontSize: 24, marginBottom: 10 }}>Privacy first</h3>
              ...
              <div className="glass-card feature-card">
                ...
                <h3 className="fs-feature-h3" style={{ fontSize: 24, marginBottom: 10 }}>One-click sharing</h3>
              ...
              <div className="glass-card feature-card">
                ...
                <h3 className="fs-feature-h3" style={{ fontSize: 24, marginBottom: 10 }}>Web2 simplicity</h3>
          ...
          <div className="container">
            ...
            <div className="step-grid">
              <div className="glass-card step-card">
                ...
                <h3 className="fs-step-h3" style={{ fontSize: 26, marginBottom: 10 }}>Sign in</h3>
                <p>Connect with Google and skip the usual wallet-installation explanation loop.</p>
              </div>
              <div className="glass-card step-card">
                <div className="step-number">2</div>
                <h3 className="fs-step-h3" style={{ fontSize: 26, marginBottom: 10 }}>Create a link</h3>
                <p>Generate a route from your dashboard and share it anywhere your customer already is.</p>
              </div>
              <div className="glass-card step-card">
                <div className="step-number">3</div>
                <h3 className="fs-step-h3" style={{ fontSize: 26, marginBottom: 10 }}>Track receipts</h3>
